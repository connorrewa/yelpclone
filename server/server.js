...
//instance of express server in app
const app = express();

app.use(cors());
//attaches info to request object
...
app.post("/api/v1/restaurants/:id/addReview", async (req, res) => {
    try{
        const newReview = await db.query("INSERT INTO reviews (restaurant_id, name, review, rating) values ($1, $2, $3, $4) returning * ;", [req.params
